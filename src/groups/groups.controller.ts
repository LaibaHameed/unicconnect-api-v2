...
export class GroupsController {
  ...
  // UPDATE group (group admin / super admin)
  @UseGuards(JwtAuthGuard)
  @Patch(':groupId')
  update(@Param('groupId') groupId: string, @Body() dto: UpdateGroupDto, @CurrentUser() user: any) {
  ...
  removeMember(@Param('groupId') groupId: string, @Param('userId') userId: string, @CurrentUser() user: any) {
